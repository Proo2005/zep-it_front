...
export default function PaymentsPage() {
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center 
                    bg-gradient-to-br from-zinc-900 via-black to-zinc-900 px-4">
        ...
        <form
          ...
          className="w-full max-w-sm 
                   ...
                   rounded-2xl p-6 shadow-2xl space-y-5"
        >
          {/* Header */}
  ...
  return (
    <div className="min-h-screen 
                  bg-gradient-to-b from-[#F4F6FB] to-[#E9EDF5] 
                  px-6 py-10">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-500 mt-1">
            Your encrypted UPI & card information
          </p>
        </div>
            ...
            {payments.map((p) => (
              ...
              >
                ...
                <div className="flex justify-between items-center mb-4">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-semibold ${p.paymentMethod === "UPI"
