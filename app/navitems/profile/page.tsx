...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB] text-[#1C1C1C] px-6 py-6  mx-auto">
  ...
  function ListItem({ text, onClick, danger, icon }: any) {
    return (
      <div
        onClick={onClick}
        className={`p-4 cursor-pointer flex items-center justify-between hover:bg-[#F4F6FB] transition ${
